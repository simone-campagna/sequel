...
_refs = [
    ...
    ["dfactorial", DoubleFactorial(), [1, 1, 2, 3, 8, 15, 48, 105]],
    ["dfactorial_even", DoubleFactorialEven(), [1, 2, 8, 48]],
    ["dfactorial_odd", DoubleFactorialOdd(), [1, 3, 15, 105]],
    ["derangements", Derangements(), [1, 0, 1, 2, 9, 44, 265, 1854]],
